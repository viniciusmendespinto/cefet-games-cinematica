...
public class RenderizadorAgente {
    ...
    private HashMap<Agente, GlyphLayout> cacheNomes = new HashMap<Agente, GlyphLayout>();
    ...
    public void desenha(Agente agente) {
        ...
        shapeRenderer.translate(agente.pose.posicao.x, agente.pose.posicao.y, 0);
        shapeRenderer.rotate(0, 0, 1, agente.pose.orientacao * ((float) (180.0f / Math.PI)));
        ...
        batch.begin();
        batch.setTransformMatrix(new Matrix4().setToTranslation(agente.pose.posicao));
